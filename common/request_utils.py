...
if __name__ == '__main__':
    ...
    # print(RequestsUtils().get_request(get_info))
    post_info = {
	'取值方式': 'json取值',
	'取值代码': '$.tag.id',
	'传值变量': 'tagid',
	'期望结果': '{"tag":{"id":(.+?),"name":"祝融峰04"}}',
	'请求参数(get)': '{"access_token":"35_aMv2lqVPwnjgDbBT-A4wER1xrQtjYtbbNz09BPKqOpSWku250ziCVlNBZUTfEuQRno5vGHNZE6WQqyONVvEHYOie0T_nHkNuVVbYvjlWqEgbqEV7NfhReMZGNYw457BKc9mgYqvfzV1SmzbsUQFjABANJY"}',
	'用例执行': '是',
	'请求方式': 'post',
	'接口名称': '创建标签接口',
